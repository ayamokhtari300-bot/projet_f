                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="premium-input-group">
                                        <label class="form-label"><i class="bi bi-person-badge-fill text-primary me-2"></i>Agent Demandeur</label>
                                        <input type="text" value="{{ auth()->user()->name }}" class="form-control bg-white" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="premium-input-group h-100">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="type_mission" id="type_mission" value="{{ old('type_mission') }}"
                                                   class="form-control @error('type_mission') is-invalid @enderror" placeholder="Ex: Technique, Commerciale..." required>
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="destination" id="destination" value="{{ old('destination') }}"
                                                   class="form-control @error('destination') is-invalid @enderror" placeholder="Ex: Alger, Oran..." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="premium-input-group h-100">
                                        <div class="mb-4">
                                            ...
                                            <input type="date" name="date_aller" id="date_aller" value="{{ old('date_aller') }}"
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="date_retour" id="date_retour" value="{{ old('date_retour') }}"
                                                   class="form-control @error('date_retour') is-invalid @enderror" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="premium-input-group">
                                        ...
                                        <small class="text-muted mt-2 d-block">Sélectionnez les agents qui vous accompagnent pour cette mission.</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="premium-input-group mb-0">
                                        <label for="description" class="form-label"><i class="bi bi-card-text text-primary me-2"></i>Description / Objet</label>
                                        <textarea name="description" id="description" rows="4"
                                                  class="form-control @error('description') is-invalid @enderror" placeholder="Détails de la mission...">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
